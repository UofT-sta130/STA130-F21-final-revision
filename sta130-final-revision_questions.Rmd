...
p_value <- sim_tibble %>% 
  filter(simulated_statistics <= 
           hypothesized_value - abs(test_stat-hypothesized_value) | 
...
```{r}
### Optional: Can do calculations here if working in JupyterHub ###
```
...
B. The most appropriate prediction model for this purpose would be one where the sensitivity is as high as possible.  
